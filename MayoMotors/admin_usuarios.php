...
if (isset($_GET['eliminar']) && !empty($_GET['eliminar'])) {
    ...
    if ($usuario_id === 'ADMIN001') {
        ...
        if ($result->num_rows === 0) {
            ...
            // Eliminar las referencias en la tabla Guardar
            ...
            if ($result_coches->num_rows > 0) {
                // El usuario tiene coches, eliminar las imágenes primero
    ...
    // Redirigir para que se evite el reenvío del formulario
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($usuario['administrador'] == 1): ?>
                                <span style="background-color: #004AFF; color: white; font-size: 0.8rem; padding: 2px 5px; border-radius: 3px;">
                                    Administrador
                                </span>
                            <?php else: ?>
                        ...
                        <td>
                            <?php if ($usuario['id_usuario'] != 'ADMIN001' && esAdmin()): ?>
                                <!-- Solo el administrador puede eliminar los usuarios -->
    ...
    <div style="margin-top: 30px; background-color: #f8f9fa; padding: 15px; border-radius: 5px;">
        ...
        <div style="display: flex; justify-content: space-around; flex-wrap: wrap;">
            <div style="text-align: center; padding: 10px;">
                <div style="font-size: 2rem; font-weight: bold; color: #004AFF;"><?php echo $stats['total_usuarios']; ?></div>
                <div>Usuarios registrados</div>
            </div>
            <div style="text-align: center; padding: 10px;">
                <div style="font-size: 2rem; font-weight: bold; color: #004AFF;"><?php echo $stats['total_admins']; ?></div>
                <div>Administradores</div>
            </div>
            <div style="text-align: center; padding: 10px;">
                <div style="font-size: 2rem; font-weight: bold; color: #004AFF;"><?php echo $stats['total_coches']; ?></div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Reemplazar confirm por mostrarConfirmacion en los botones de eliminar
