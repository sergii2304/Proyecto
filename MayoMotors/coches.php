...
if (isset($_GET['buscar'])) {
    ...
    if (!empty($_GET['precio_min']) && $_GET['precio_min'] !== '') {
    ...
    if (!empty($_GET['precio_max']) && $_GET['precio_max'] !== '') {
    ...
    <form action="coches.php" method="get" id="filter-form">
        <div class="filter-grid">
            ...
            <div class="form-group">
                ...
                <input type="number" id="cv" name="cv" min="65" max="5000" class="form-control" 
                    value="<?php echo isset($_GET['cv']) && $_GET['cv'] !== '' ? htmlspecialchars(min(max((int)$_GET['cv'], 65), 5000)) : ''; ?>">
                <small class="text-muted">Min: 65CV Max: 5000CV</small>
            </div>

            <div class="form-group">
                <label for="precio_min">Precio mínimo</label>
                <input type="number" id="precio_min" name="precio_min" min="1" max="999999" class="form-control" 
                    value="<?php echo isset($_GET['precio_min']) && $_GET['precio_min'] !== '' ? htmlspecialchars(min(max((int)$_GET['precio_min'], 1), 999999)) : ''; ?>">
                <small class="text-muted">Min: 1€</small>
            </div>

            <div class="form-group">
                <label for="precio_max">Precio máximo</label>
                <input type="number" id="precio_max" name="precio_max" min="1" max="999999" class="form-control" 
                    value="<?php echo isset($_GET['precio_max']) && $_GET['precio_max'] !== '' ? htmlspecialchars(min(max((int)$_GET['precio_max'], 1), 999999)) : ''; ?>">
