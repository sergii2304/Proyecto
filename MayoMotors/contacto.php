...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (!preg_match("/^[A-Za-zÁáÉéÍíÓóÚúÜüÑñ\s]+$/", $nombre)) {
...
<?php else: ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (formContacto) {
            // Validar en tiempo real para nombre
            const nombreInput = document.getElementById('nombre');
            nombreInput.addEventListener('blur', function() {
                validarNombre(nombreInput);
            });
            
            // Validar en tiempo real para correo
            const correoInput = document.getElementById('correo');
            correoInput.addEventListener('blur', function() {
                validarCorreo(correoInput);
            });
            
            // Validar en tiempo real para mensaje
            ...
            formContacto.addEventListener('submit', function(e) {
                ...
                if (!validarNombre(nombreInput)) isValid = false;
                if (!validarCorreo(correoInput)) isValid = false;
                if (!validarMensaje(mensajeInput)) isValid = false;
        ...
        function validarNombre(campo) {
            ...
            if (!regex.test(valor)) {
                mostrarError(campo, 'El nombre solo debe contener letras y espacios');
                return false;
            }
        ...
        function validarCorreo(campo) {
            ...
            // Validar formato de email con regex más completo
