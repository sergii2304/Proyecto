...
// Verificar si la columna 'km' existe en la tabla
$check_km = $conn->query("SHOW COLUMNS FROM Coches LIKE 'km'");
$km_exists = $check_km && $check_km->num_rows > 0;

// Obtener detalles del coche - incluir descripción y km si existen
if ($desc_exists && $km_exists) {
    $sql = "SELECT c.id_coche, c.matricula, c.precio, c.color, c.cambio, c.ano, c.combustible, c.cv, c.fecha, c.descripcion, c.km,
    ...
    $sql = "SELECT c.id_coche, c.matricula, c.precio, c.color, c.cambio, c.ano, c.combustible, c.cv, c.fecha, c.km,
                  M.nombre as marca, MD.nombre as modelo, 
                  p.nombre as provincia, u.nombre as vendedor, u.telefono, u.correo
           FROM Coches c
           INNER JOIN Modelos MD ON c.id_modelo = MD.id_modelo
...
<div class="details-container">
    ...
    <div class="details-grid">
        ...
        <div class="form-group">
            <label>Km</label>
            <input type="text" class="form-control" readonly value="<?php echo isset($coche['km']) ? number_format($coche['km'], 0, ',', '.') : '0'; ?>">
        </div>
        ...
        favButton.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Reemplazar alert nativo por mostrarAlerta
