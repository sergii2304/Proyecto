...
<script>
// Script específico para la página de inicio con carga de 10 segundos
document.addEventListener('DOMContentLoaded', function() {
    // Forzar un tiempo de carga exacto de 10 segundos para la página principal
    const loader = document.getElementById('loader-wrapper');
    const counter = document.querySelector('.loader-counter');
    
    if (loader && counter) {
        // Tiempo fijo de 10 segundos (10000 ms)
        const totalLoadTime = 10000;
        ...
        // Ocultar el loader exactamente después de 10 segundos
        setTimeout(function() {
